...
<head>
  ...
  <?= $this->Html->css('/node_modules/@coreui/icons/css/coreui-icons.min') ?>
  <?= $this->Html->css('/node_modules/flag-icon-css/css/flag-icon.min') ?>
  <?= $this->Html->css('/node_modules/font-awesome/css/font-awesome.min') ?>
  <?= $this->Html->css('/node_modules/simple-line-icons/css/simple-line-icons') ?>
  <?= $this->Html->css('/vendors/pace-progress/css/pace.min') ?>
  <?= $this->Html->css('select2.min') ?>
  <?= $this->Html->css('daterangepicker') ?>

  <?= $this->Html->css('style.css') ?>
  <?= $this->Html->css('file_style.css') ?>
...
<?= $this->Html->script('/node_modules/jquery/dist/jquery.min') ?>
<?= $this->Html->script('/node_modules/popper.js/dist/umd/popper.min') ?>
<?= $this->Html->script('/node_modules/bootstrap/dist/js/bootstrap.min') ?>
<?= $this->Html->script('/node_modules/pace-progress/pace.min') ?>
<?= $this->Html->script('/node_modules/perfect-scrollbar/dist/perfect-scrollbar.min') ?>
<?= $this->Html->script('/node_modules/@coreui/coreui-pro/dist/js/coreui.min') ?>
<?= $this->Html->script('select2.min') ?>
<?= $this->Html->script('moment.min') ?>
<?= $this->Html->script('daterangepicker.min') ?>

<?= $this->Html->script('site-script') ?>
